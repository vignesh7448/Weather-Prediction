		...
		public void map(LongWritable key, Text value, Context context)
		{
				...
				if(line!=null && line.length>0)
				{
					...
					if(!date.equals("Date"))
					{
						...
						System.out.println(dateArray[0].replace("\"", ""));
//						String[] dateArray=date.split("-");
						String month=dateArray[0].replace("\"","");
						month=String.valueOf(MonthValue.month(month));
						String year=line[1].replace("\"", "").trim();
//						String year=line[0];
