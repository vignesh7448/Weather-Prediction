 		...
 		<div class="row"> 
			<div class="col-md-6 col-md-offset-3">
				<div class="portfolios">
					...
					<%
					ArrayList<String> al = (ArrayList)session.getAttribute("classify");
					if(al!=null){
					...
					<%}}session.setAttribute("classify", null); %>
					</table>
					<div style="width: 1000px">
					
					<%
					ArrayList<String> al1 = (ArrayList)session.getAttribute("cluster");
					if(al1!=null){
