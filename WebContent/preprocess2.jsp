			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="view.jsp">View Prediction</a></li>				
					</ul>
				</div>
			</div>			
		</div>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="portfolios">
					<div class="text-center">
						<h2>Welcome Admin</h2>
						<div id="container1">
						<form action="PreServlet" method="post">
							<table>
							<tr>
							<td><input type="submit" value="Preprocess"/></td>
							</tr>
							</table>
							</form>
						</div>
					...
					<%
					ArrayList<String> al = (ArrayList)session.getAttribute("preprocess2");
					if(al!=null){
